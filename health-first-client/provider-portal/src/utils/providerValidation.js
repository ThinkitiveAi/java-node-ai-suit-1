// Provider-specific validation utilities
...
export const validateSpecialization = (specialization) => {
  ...
  if (trimmed.length < 3) {
    return { isValid: false, message: 'Specialization must be at least 3 characters long' };
  }
  
  if (trimmed.length > 100) {
    return { isValid: false, message: 'Specialization must be less than 100 characters long' };
  }
...
export const validateLicenseNumber = (licenseNumber) => {
  ...
  if (trimmed.length > 20) {
    return { isValid: false, message: 'License number must be less than 20 characters long' };
  }
...
export const validateYearsOfExperience = (years) => {
  ...
  if (isNaN(numYears) || numYears < 0) {
    return { isValid: false, message: 'Years of experience must be a positive number' };
  }
  
  if (numYears > 50) {
    return { isValid: false, message: 'Years of experience must be less than 50' };
  }
